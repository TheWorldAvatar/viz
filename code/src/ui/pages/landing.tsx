...
export default function LandingPage(props: Readonly<LandingPageProps>) {
  ...
  return (
    <div className="bg-muted border-border   rounded-xl border-1  shadow-2xl mx-auto mt-4 flex h-[85vh]  p-2 sm:w-[95vw] md:h-[85vh] md:w-[95vw] lg:h-[85vh] lg:w-[95vw] lg:p-4  xl:h-10/12 xl:w-[70vw] 2xl:h-[85vh]  ">
      <div
