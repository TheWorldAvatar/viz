...
export default function Button({
  ...
  const baseStyles =
    "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md  font-medium transition-all ease-linear duration-50 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none  focus-visible:ring-zinc-400 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive";
  ...
  const variantStyles = {
    ...
    destructiveOutline:
      "bg-transparent text-red-400 hover:bg-red-100 dark:text-red-600 dark:hover:bg-red-200",
    outline:
