...
import { getDisabledDates } from "../billing-table-utils";
                        ...
                        <div className="flex flex-wrap items-center justify-between sm:gap-4 gap-1">
                                ...
                                permissionScheme?.hasPermissions.pendingRegistry) && (
                                    <div className="sm:w-auto">
                                        <RedirectButton
                                            ...
                                            variant={
                                                props.entityType == "billing_accounts" ? "active" : "ghost"
                                            }
                            ...
                            <div className="sm:w-auto">
                                <RedirectButton
                                    ...
                                    variant={
                                        props.entityType == "pricing_models" ? "active" : "ghost"
                                    }
                                    className="w-full sm:w-auto py-3 sm:py-2 text-sm font-medium"
                                />
                            </div>
                            <div className="sm:w-auto">
                                <RedirectButton
                                    ...
                                    variant={
                                        props.entityType == "billing_activity" ? "active" : "ghost"
                                    }
                                    className="w-full sm:w-auto py-3 sm:py-2 text-sm font-medium"
                                />
                            </div>
