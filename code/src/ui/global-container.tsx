    ...
    <Provider store={reduxStore}>
      ...
      >
        ...
        <div className="flex h-screen w-full">
          ...
          <div className="mx-auto mt-4 md:mt-0 flex h-4/5 items-center justify-center p-2 sm:w-sm md:h-11/12 md:w-11/12 lg:h-11/12 lg:w-11/12 lg:p-4 xl:mt-0 xl:h-10/12 xl:w-9/12 2xl:h-11/12">
            {props.children}
          </div>
        </div>
