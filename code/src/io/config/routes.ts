...
export const Paths: {
  ...
  REGISTRY_TASK_ACCRUAL: `${REGISTRY_TASK}/billable`,
  REGISTRY_TASK_EXEMPT: `${REGISTRY_TASK}/exempt`,
...
export const Routes: {
  ...
  REGISTRY_TASK_ACCRUAL: `${ASSET_PREFIX}/${Paths.REGISTRY_TASK_ACCRUAL}`,
  REGISTRY_TASK_EXEMPT: `${ASSET_PREFIX}/${Paths.REGISTRY_TASK_EXEMPT}`,
