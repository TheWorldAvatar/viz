...
/**
 * Displays the form page for adding a pricing plan to the customer account.
 */
export default async function InterceptAddCustomerAccountPricingPlanFormPage(props: Readonly<InterceptAddFormPageProps>) {
