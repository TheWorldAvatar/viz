...
interface TerminateFormPageProps {
    params: Promise<{
        id: string,
        type: string,
    }>
...
/**
 * Displays the form page for terminating one item.
 * 
 * @returns React component for display. 
 */
export default async function TerminateFormPage(props: Readonly<TerminateFormPageProps>) {
